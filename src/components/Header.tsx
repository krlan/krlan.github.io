  ...
  return (
    ...
    >
      <div className="flex items-baseline gap-3 mb-2">
        ...
        <span className="status-badge font-mono text-xs text-[var(--accent)] flex items-center gap-1.5">
      ...
      {/* Stats bar */}
      <div className="stats-bar flex gap-6 mb-3 font-mono text-xs">
      ...
      <div className="contact-info font-mono text-xs text-[var(--text-muted)] flex flex-wrap gap-4">
        <span>remote</span>
